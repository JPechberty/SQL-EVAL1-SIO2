...
CREATE TABLE `lecon` (
  ...
  `NumImmat` varchar(50) DEFAULT NULL,
...
INSERT INTO `lecon` (`CodeLecon`, `Date`, `Heure`, `Duree`, `NumMoniteur`, `NumEleve`, `NumImmat`, `Reglee`, `CompteurInitial`, `CompteurFinal`) VALUES
...
INSERT INTO `licence` (`CodeLicence`, `NumMoniteur`, `NumCategorie`, `DateObtention`) VALUES
(1, 11, 1, NULL),
(2, 11, 4, NULL),
(3, 11, 5, NULL),
(4, 8, 3, NULL),
...
INSERT INTO `vehicule` (`Immatriculation`, `Marque`, `Modele`, `Annee`, `NumCategorie`) VALUES
...
ALTER TABLE `lecon`
  ...
  ADD KEY `CodeMoniteur` (`NumMoniteur`),
  ADD KEY `CodeEleve` (`NumEleve`),
  ADD KEY `Immatriculation` (`NumImmat`);
...
ALTER TABLE `licence`
  ...
  ADD KEY `CodeMoniteur` (`NumMoniteur`,`NumCategorie`),
  ADD KEY `CodeCategorie` (`NumCategorie`);
...
--
ALTER TABLE `lecon`
  ADD CONSTRAINT `lecon_ibfk_1` FOREIGN KEY (`NumMoniteur`) REFERENCES `moniteur` (`CodeMoniteur`),
  ADD CONSTRAINT `lecon_ibfk_2` FOREIGN KEY (`NumEleve`) REFERENCES `eleve` (`CodeEleve`),
  ADD CONSTRAINT `lecon_ibfk_3` FOREIGN KEY (`NumImmat`) REFERENCES `vehicule` (`Immatriculation`);

--
-- Contraintes pour la table `licence`
--
ALTER TABLE `licence`
  ADD CONSTRAINT `licence_ibfk_1` FOREIGN KEY (`NumMoniteur`) REFERENCES `moniteur` (`CodeMoniteur`),
  ADD CONSTRAINT `licence_ibfk_2` FOREIGN KEY (`NumCategorie`) REFERENCES `categorie` (`CodeCategorie`);

--
-- Contraintes pour la table `vehicule`
--
ALTER TABLE `vehicule`
  ADD CONSTRAINT `vehicule_ibfk_1` FOREIGN KEY (`NumCategorie`) REFERENCES `categorie` (`CodeCategorie`);
COMMIT;
